...
class Bingo extends Component {
  ...
  getRunda = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        this.setState({
          brojevi: res.data.drawnNum,
          finish: res.data.finishRoundTime,
          loading: false,
          rundaGotova: false,
        });
        ...
        preostali = this.brojPreostalih(
          this.preostaloVrijeme(this.state.finish)
        );
      })
      .then(() => {
        let noviNiz = [];
  ...
  render() {
    ...
    return <CurrentNumbers roundNumbers={this.state.izvuceni} />;
  }
}
